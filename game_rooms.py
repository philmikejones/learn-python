rooms = {
    ...
    "eastgroundrearcorridor" : {
      ...
      "items"  : None,
      "description" : "A winding corridor that takes you to the rear of the mansion. There is a bathroom, a study, and an outside store accessed from this corridor. Otherwise there is nothing of note."
    }
}
